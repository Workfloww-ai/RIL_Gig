...
export default function FinanceDashboard() {
  ...
  // Custom logic to determine Present vs Past
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl bg-cream shadow-sm border border-gray-100 overflow-hidden">
        <div className="bg-sand border-b border-gray-200 p-3 px-4 flex items-center justify-between">
          <h3 className="font-semibold text-moss">Today's Jobs (Completed by 8 PM)</h3>
...
with open('/Users/monalikagoel/Documents/RIL_Gig/finance/app/finance/page.tsx', 'w') as f:
    f.write(content)
